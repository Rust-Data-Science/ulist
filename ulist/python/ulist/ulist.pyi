...
class BooleanList:
    ...
    def all(self) -> bool: ...
    def all_equal(self, other: BooleanList) -> bool: ...
...
class FloatList32:
    ...
    def all_equal(self, other: FloatList32) -> bool: ...
    def append(self, elem: ELEM_OPT) -> None: ...
    def argmax(self) -> int: ...
    def argmin(self) -> int: ...
...
class FloatList64:
    ...
    def all_equal(self, other: FloatList64) -> bool: ...
    def append(self, elem: ELEM_OPT) -> None: ...
    def argmax(self) -> int: ...
    def argmin(self) -> int: ...
    def as_bool(self) -> BooleanList: ...
...
class IntegerList32:
    ...
    def all_equal(self, other: IntegerList32) -> bool: ...
    def append(self, elem: ELEM_OPT) -> None: ...
    def argmax(self) -> int: ...
    def argmin(self) -> int: ...
    def as_bool(self) -> BooleanList: ...
...
class IntegerList64:
    ...
    def all_equal(self, other: IntegerList64) -> bool: ...
    def append(self, elem: ELEM_OPT) -> None: ...
    def argmax(self) -> int: ...
    def argmin(self) -> int: ...
    def as_bool(self) -> BooleanList: ...
...
class StringList:
    ...
    def all_equal(self, other: StringList) -> bool: ...
    def append(self, elem: ELEM_OPT) -> None: ...
    def as_bool(self) -> BooleanList: ...
    def as_float32(self) -> FloatList32: ...
    def as_float64(self) -> FloatList64: ...
