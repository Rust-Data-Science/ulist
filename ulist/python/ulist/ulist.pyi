...
class BooleanList:
    ...
    def equal(self, other: BooleanList) -> BooleanList: ...
    ...
    def not_equal(self, other: BooleanList) -> BooleanList: ...
...
class FloatList32:
    ...
    def equal(self, other: FloatList32) -> BooleanList: ...
    def equal_scala(self, elem: ELEM) -> BooleanList: ...
    ...
    def not_equal(self, other: FloatList32) -> BooleanList: ...
...
class FloatList64:
    ...
    def equal(self, other: FloatList64) -> BooleanList: ...
    def equal_scala(self, elem: ELEM) -> BooleanList: ...
    ...
    def not_equal(self, other: FloatList64) -> BooleanList: ...
    def not_equal_scala(self, elem: NUM) -> BooleanList: ...
    def pop(self) -> None: ...
...
class IntegerList32:
    ...
    def div(self, other: NUM_LIST_RS) -> FloatList32: ...
    def div_scala(self, elem: float) -> FloatList32: ...
    def equal(self, other: IntegerList32) -> BooleanList: ...
    def equal_scala(self, elem: ELEM) -> BooleanList: ...
    ...
    def not_equal(self, other: IntegerList32) -> BooleanList: ...
    def not_equal_scala(self, elem: NUM) -> BooleanList: ...
    def pop(self) -> None: ...
...
class IntegerList64:
    ...
    def div(self, other: NUM_LIST_RS) -> FloatList64: ...
    def div_scala(self, elem: float) -> FloatList64: ...
    def equal(self, other: IntegerList64) -> BooleanList: ...
    def equal_scala(self, elem: ELEM) -> BooleanList: ...
    ...
    def not_equal(self, other: IntegerList64) -> BooleanList: ...
    def not_equal_scala(self, elem: NUM) -> BooleanList: ...
    def pop(self) -> None: ...
